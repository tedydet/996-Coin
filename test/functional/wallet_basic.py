...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 NNS from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 NNS in block rewards plus fees, but
        ...
        # Send 10 NNS with subtract fee from amount
        ...
        # Sendmany 10 NNS with subtract fee from amount
